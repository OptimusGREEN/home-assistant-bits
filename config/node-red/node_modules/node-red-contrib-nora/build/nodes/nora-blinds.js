...
module.exports = function (RED) {
    RED.nodes.registerType('nora-blinds', function (config) {
        var _this = this;
        ...
        this.on('input', function (msg) {
            ...
            if (typeof msg === 'object' && typeof msg.payload === 'object') {
                ...
                if ('openPercent' in payload && typeof payload.openPercent === 'number' && isFinite(payload.openPercent)) {
                    state$.next(tslib_1.__assign({}, state$.value, { openPercent: Math.floor(Math.max(0, Math.min(100, payload.openPercent))) }));
                }
            }
        });
